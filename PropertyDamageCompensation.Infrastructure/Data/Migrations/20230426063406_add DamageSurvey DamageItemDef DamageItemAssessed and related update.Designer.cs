...
namespace PropertyDamageCompensation.Web.Data.Migrations
{
    ...
    [Migration("20230426063406_add DamageSurvey DamageItemDef DamageItemAssessed and related update")]
    partial class addDamageSurveyDamageItemDefDamageItemAssessedandrelatedupdate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PropertyDamageCompensation.Web.Areas.Compensation.Entities.DamageItemAssessed", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("DamageItemDefId")
                        .HasColumnType("int");

                    b.Property<int>("DamageItemDefPrice")
                        .HasColumnType("int");

                    b.Property<int?>("DamageSurveyId")
                        .HasColumnType("int");

                    b.Property<int>("DamgeSurveyId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DamageItemDefId");

                    b.HasIndex("DamageSurveyId");

                    b.ToTable("DamageItemAssessed");
                });

            modelBuilder.Entity("PropertyDamageCompensation.Web.Areas.Compensation.Entities.DamageItemDef", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("DamageItemDef");
                });

            modelBuilder.Entity("PropertyDamageCompensation.Web.Areas.Compensation.Entities.DamageSurvey", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("DamageSurvey");
                });

            modelBuilder.Entity("PropertyDamageCompensation.Web.Areas.Compensation.Entities.District", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PropertyDamageCompensation.Web.Areas.Compensation.Entities.DistrictEngineer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PropertyDamageCompensation.Web.Areas.Compensation.Entities.DamageItemAssessed", b =>
                {
                    b.HasOne("PropertyDamageCompensation.Web.Areas.Compensation.Entities.DamageItemDef", "DamageItemDef")
                        .WithMany("DamageItemAssessed")
                        .HasForeignKey("DamageItemDefId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PropertyDamageCompensation.Web.Areas.Compensation.Entities.DamageSurvey", "DamageSurvey")
                        .WithMany("DamageItemAssessed")
                        .HasForeignKey("DamageSurveyId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("DamageItemDef");

                    b.Navigation("DamageSurvey");
                });

            modelBuilder.Entity("PropertyDamageCompensation.Web.Areas.Compensation.Entities.DamageSurvey", b =>
                {
                    b.HasOne("PropertyDamageCompensation.Web.Areas.Compensation.Entities.Application", "Application")
                        .WithMany("DamageSurvey")
            ...
            modelBuilder.Entity("PropertyDamageCompensation.Web.Areas.Compensation.Entities.DistrictEngineer", b =>
                {
                    b.HasOne("PropertyDamageCompensation.Web.Areas.Compensation.Entities.District", "District")
                        .WithMany("DistrictEngineers")
                        .HasForeignKey("DistrictId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PropertyDamageCompensation.Web.Data.ApplicationUser", "ApplicationUser")
                        .WithMany("DistrictEngineer")
                        .HasForeignKey("EngineerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("PropertyDamageCompensation.Web.Areas.Compensation.Entities.DamageItemDef", b =>
                {
                    b.Navigation("DamageItemAssessed");
                });
            ...
            modelBuilder.Entity("PropertyDamageCompensation.Web.Areas.Compensation.Entities.District", b =>
                {
                    b.Navigation("DistrictEngineers");
                });
